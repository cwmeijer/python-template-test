...
git clone git@github.com:<my-github-organization>/my-python-project .
...
Don't forget to also make a [release on GitHub](git@github.com:<my-github-organization>/my-python-project/releases/new). If your repository uses the GitHub-Zenodo integration this will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.
