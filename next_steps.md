...
git branch -M main
git remote add origin git@github.com:<my-github-organization>/my-python-project
```
...
automatically ([here](git@github.com:<my-github-organization>/my-python-project/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
